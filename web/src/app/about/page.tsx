					...
					<div className="space-y-8">
						...
						<section className="space-y-3">
							...
							<p className="text-sm" style={{ color: "var(--muted-80)" }}>
								...
								for all other devices. I'm actively exploring which platform to
								support next, with a focus on fully leveraging each platform's
								native features. The goal is to make copy, paste, and sharing as
								efficient as possible on every device, which means deep
								integration with platform-specific capabilities rather than a
